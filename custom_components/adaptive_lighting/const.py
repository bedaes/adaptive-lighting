...
CONF_SEPARATE_TURN_ON_COMMANDS_DELAY, DEFAULT_SEPARATE_TURN_ON_COMMANDS_DELAY = (
...
VALIDATION_TUPLES = [
    ...
    (CONF_SEPARATE_TURN_ON_COMMANDS_DELAY, DEFAULT_SEPARATE_TURN_ON_COMMANDS_DELAY, int_between(0,5000)),
